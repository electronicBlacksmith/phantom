...
export class EvolutionEngine {
	...
	// Snapshot the config dir after a successful evolution. Retains the last 5
	// version-directories under data/config-backups/ as a belt-and-suspenders
	// safety net independent of the git-like versioning in versioning.ts.
